...
import {
  cartsUserAPI,
  decrementProductFromCartAPI,
  incrementProductFromCartAPI,
        ...
        {user.cartsId?.length >= 1 && cart?.totalPrice > 0 ? (
                              ...
                              <div class="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                                <div class="flex items-center border-gray-100">
                                  <span
                                    ...
                                    onClick={() =>
                                      handleDecrementcart(percart?.productId)
                                    }
                                  >
                                    {" "}
                                    -{" "}
                                  ...
                                  <span
                                    ...
                                    onClick={() =>
                                      handleIncrementCart(percart?.productId)
                                    }
                                  >
                                    {" "}
                                    +{" "}
                                ...
                                <div class="flex items-center ">
                                  <p
                                    class=" w-[5rem] cursor-pointer duration-150 bg-red-600 p-2 text-sm text-center text-white"
                                    onClick={() =>
                                      handleRemoveCart(percart?.productId)
                                    }
                                  >
                                    Remove
                                  </p>
          ...
          <>
            ...
            <div className="mb-10 mt-2">
              <img
                src={cartImage02}
                className="block m-auto h-[12rem] "
                alt=""
              />
              <p className="mt-3 text-gray-400 text-center md:text-xl ">
